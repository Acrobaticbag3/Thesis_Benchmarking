...
A [timoni.sh](http://timoni.sh) module for deploying test-mod to Kubernetes clusters.
...
```shell
timoni -n default apply test-mod oci://<container-registry-url>
```
...
```shell
timoni -n default delete test-mod
```
